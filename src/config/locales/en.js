...
const messages = defineMessages({
  ...
  planningInvestibleNextStageAcceptedLabel: 'Not Ready For Feedback',
  planningInvestibleNextStageAcceptedFullLabel: 'Not Ready For Feedback (Full)',
  ...
  planningAcceptedStageDescription: 'Stories in \'Not Ready For Feedback\' per person per workspace is a setting. A story in \'Not Ready For Feedback\' past its estimated completion date will show yellow until a progress report is entered.',
  ...
  planningReviewStageDescription: 'Ready for Feedback is for stories that can be partially reviewed. Stories with unresolved comments show red.',
  ...
  stageHelp3: 'When you start a story put it into "Not Ready For Feedback" (hopefully approved) - the fewer pre-review stories the better.',
  stageHelp4: 'When there is anything to show put the story in "Ready for Feedback"',
  ...
  acceptedInvestiblesUpdatedAt: 'Entered stage on ',
  reviewingInvestiblesUpdatedAt: 'Entered stage on ',
  inDialogInvestiblesUpdatedAt: 'Assigned for approval on ',
  verifiedInvestiblesUpdatedAt: 'Verified on ',
  ...
  planningInvestibleEnoughVotesHelp: 'This story has approval so consider using the up arrow to move to \'Not Ready For Feedback\'',
