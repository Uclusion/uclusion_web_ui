...
const messages = defineMessages({
  ...
  startedExpirationLabel: 'Doable expiration in days',
  ...
  certaintyTipNOT_READY: 'ctrl+alt+4',
  certaintyTipREADY: 'ctrl+alt+3',
  certaintyTipAPPROVABLE: 'ctrl+alt+2',
  ...
  labels: 'Labels',
  previousNavigation: 'ctrl+arrowLeft Back',
  previousNavigationMac: 'ctrl+option+arrowLeft Back',
  nextNavigation: 'ctrl+arrowRight does what this Next, View, or In progress button currently says',
  nextNavigationMac: 'ctrl+option+arrowRight does what this Next, View, or In progress button currently says',
  upNavigation: 'ctrl+arrowUp go up one level',
  upNavigationMac: 'ctrl+option+arrowUp go up one level',
  unrespondedNavigation: 'ctrl+arrowDown Unresponded',
  unrespondedNavigationMac: 'ctrl+option+arrowDown Unresponded',
  navNextMessage: 'Next message',
  navView: 'View',
  navBack: 'Back',
  up: 'Up',
  skipDemo: 'Skip demo',
  ...
  jobTypeLabelAPPROVABLE: 'Approvable - assign to me for approval',
  ...
  planningInvestibleToVotingLabel: 'Approvable',
  planningMobileToVotingLabel: 'Approvable',
  inboxVotingLabel: 'Approvable',
  planningInvestibleNextStageAcceptedLabel: 'Doable',
  planningAcceptedStageLabel: 'Doable',
  ...
  planningInvestibleNextStageInReviewLabel: 'Reviewable',
  planningInvestibleMoveToVerifiedLabel: 'Reviewable',
  planningInvestibleMoveToFurtherWorkLabel: 'Backlog',
  planningInvestibleMoveToNotDoingLabel: 'Skippable',
  move: 'Move',
  planningInvestibleNotDoingExplanation: 'Move to Skippable will unassign and archive the job',
  planningVotingStageLabel: 'Approvable',
  verifiedBlockedStageLabel: 'Verified',
  planningReviewStageLabel: 'Reviewable',
  ...
  planningVerifiedStageLabel: 'Reviewable',
  planningFurtherWorkStageLabel: 'Backlog',
  requiresInputStageLabel: 'Debatable',
  assistanceUnresponded: 'Unresponded',
  assistanceResponded: 'Responded',
  assistanceResolved: 'Resolved',
  ...
  startedExpirationHelp: "Days in Doable without progress report or estimated due date.",
  ...
  proceedRequiresInput: 'Debatable',
  ...
  commentAddSendDelegate: 'Send and delegate',
  ...
  commentDelegateLabel: 'Delegate',
  commentDelegateExplanation: 'Delegate this choice to AI without selecting an option.',
  ...
  DiscussionCommentAddREPORT: 'Add note',
  ...
  addResolve: 'Add and resolve',
  addDelegate: 'Add and delegate',
  ...
  switchWorkspace: 'Other workspaces',
  switchGroup: 'View',
  ...
  planningDialogDiscussionLabel: 'Notes / Discussion',
  ...
  promoteOptionExplanation: 'Move option to approvable stage for voting',
  demoteOption: 'Prevent voting',
  demoteOptionExplanation: 'Move option to proposed stage and stop voting',
  ...
  notDoingBacklogToolTip: 'Skippable jobs are dormant and unassigned but kept for reference.',
  ...
  jobTasksToolTip: 'All open tasks for this job.',
  jobNotesToolTip: 'All job task and job level notes.',
  ...
  createApprovalExplanation: 'Create a new approval for this option',
  ...
  requiresInputListHeader: 'Warning: unless you resolve some comments the current assignment will move the job to Debatable.',
  ...
  // Dialog Archives
  dialogArchivesNotDoingHeader: 'Skippable',
  dialogArchivesVerifiedHeader: 'Reviewable',
  dialogArchivesLabel: 'View Archive',
  showAllComplete: 'Show all',
  completeJobsTitle: 'Reviewable Jobs',
  viewFilterLabel: 'Show jobs for view:',
  viewFilterAll: 'All views',
  readyFurtherWorkHeader: 'Backlog',
  readyToStartHeader: 'Ready to Assign',
  notReadyToStartHeader: 'Not Ready',
  notDoingHeader: 'Skippable',
  backlogReadyToStartHeader: 'Backlog - Ready to Assign',
  backlogNotReadyToStartHeader: 'Backlog - Not Ready',
  backlogNotDoingHeader: 'Backlog - Skippable',
  blockedHeader: 'Next / Debatable',
  ...
  // Agent setup approval
  setupTitle: 'Connect Uclusion',
  setupLoading: 'Loading this setup request…',
  setupFinishingAccount: 'Finishing account setup… This can take a few seconds after Google or GitHub sign-in.',
  setupRetryable: 'Uclusion could not load this setup request yet. You can safely try again.',
  setupRetry: 'Try again',
  setupReviewPrompt: 'Review the exact setup your coding agent requested. Nothing is created until you approve.',
  setupWorkspace: 'Workspace',
  setupClient: 'AI client',
  setupScope: 'Install scope',
  setupScopeGlobal: 'Global — available in all projects',
  setupScopeProject: 'Current project',
  setupTokenAudit: 'Token usage notes',
  setupWorkClaims: 'Work-claim locking',
  setupEnabled: 'On',
  setupDisabled: 'Off',
  setupCurrentAccount: 'Approving account',
  setupExpires: 'This request expires {expiry}.',
  setupApprove: 'Approve',
  setupDeny: 'Deny',
  setupApprovedTitle: 'Setup approved',
  setupApprovedBody: 'Return to your coding agent. It can now finish connecting Uclusion.',
  setupCompletingBody: 'Your coding agent is finishing this setup. Return to it for the next instruction.',
  setupDeniedTitle: 'Setup denied',
  setupDeniedBody: 'Nothing was created. Return to your coding agent if you want to start a new setup.',
  setupExpiredTitle: 'Setup expired',
  setupExpiredBody: 'This approval link is no longer active. Return to your coding agent to start a new setup.',
  setupConsumedTitle: 'Setup complete',
  setupConsumedBody: '{workspace} was created. Opening it now…',
  setupWorkspaceOpenFailed: 'Uclusion could not open the workspace automatically. Reload this page to try again.',
  setupWrongAccountTitle: 'Different account',
  setupWrongAccountBody: 'This setup was approved with a different Uclusion account. Sign in with that account or start a new setup.',
  setupSwitchAccount: 'Switch account',
  setupUnavailableTitle: 'Setup unavailable',
  setupUnavailableBody: 'This setup link is invalid or no longer available. Return to your coding agent to start a new setup.',
  ...
  errorPokeAIFailed: 'There was a problem poking AI. Please try again.',
  ...
  showInvestiblesDropdownHelp: 'Number of jobs to allow in Reviewable swimlane per person',
  showInvestiblesDropdownAgeHelp: 'Maximum age of jobs shown in Reviewable swimlanes.',
  ...
  todoInfo: 'Info',
  reportNote: 'Note',
  intentDesignCapsule: 'Design',
  supersededIntentDesignCapsule: 'Superseded intent/design capsule',
  capsuleJobTarget: 'Job {target}',
  capsuleTaskTarget: 'Task {target}',
  issueSimple: 'issue',
  ...
  createQuestionMobile: 'Question',
  createNote: 'Add note',
  createNoteMobile: 'Note', 
  createSuggestion: 'Add suggestion',
  createSuggestionMobile: 'Suggestion',
  ...
  isVisibleCheckboxExplanation: 'Show AI',
  ...
  moveTodoResolved: 'Resolve this bug',
  resolvedBugsHeader: 'Resolved',
  resolvedToolTip: 'Resolved bugs are kept for reference. Drag back to a severity tab to unresolve.',
  ...
  DecideStartBug: 'Create job in Doable',
  ...
  JobAssignNotDoing: 'Move to Skippable',
  JobAssignStart: 'Move to Doable',
  JobAssignBacklog: 'Move to Backlog',
  JobAssignWaiting: 'Move to Approvable',
  ...
  WORKSPACEComposeLabel: 'Workspace - everyone in a workspace can see all contents',
  compose: 'Compose',
