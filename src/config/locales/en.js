...
const messages = defineMessages({
  ...
  createdWorkspaceGreeting: 'Welcome to Uclusion {name}',
  createdWorkspaceContent: 'We created a Workspace for you to help you get started.',
  createdWorkspaceStart: 'Go to the Workspace',
  new: 'New',
