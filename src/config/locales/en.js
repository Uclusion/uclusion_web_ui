...
const messages = defineMessages({
  ...
  planningVotingStageDescription: 'Approvals collected while in Ready for Approval will expire if the story is not started. Stories with zero approvals or unresolved comments show red.',
  ...
  stageHelp3: 'Then move the story to "Not Ready For Feedback" ',
  stageHelp4: 'or if there is anything to show put the story in "Ready for Feedback"',
