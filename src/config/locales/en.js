...
const messages = defineMessages({
  ...
  assignTodo: 'Please assign TODO',
  assignTask: 'Please assign task',
  ...
  unreadOption: 'Please consider option',
  issue: 'Please help resolve',
  unPromotedOption: 'Please promote option',
  dialogClosing: 'Dialog closing',
  initiativeClosing: 'Initiative closing',
  ...
  missingProgress: 'Missing progress report',
  addCollaborators: 'Please add collaborators',
  pleaseUpgrade: 'Please upgrade',
  unreadReply: 'View comment reply',
  unreadResolved: 'View resolved comment',
  ...
  ticketSubCodeHelp: 'A short code for the workspace which will be used to form human readable task ids',
  ...
  archiveWarning: 'Archiving will unassign any active task and prevent further assignment. Deactivating stops the Workspace.',
