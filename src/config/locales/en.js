...
const messages = defineMessages({
  ...
  startedExpirationHelp: "Days a job can be in Accepted without progress report or estimated due date.",
  ...
  addReportInReadyForApprovalWarning: 'Consider moving job to \'Accepted\'.',
  ...
  DecideStartBug: 'Create job in Accepted',
