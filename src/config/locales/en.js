...
const messages = defineMessages({
  ...
  noQuestionUploads: 'Questions should go in their own comment and pictures should go in the story.',
  noUploads: 'Pictures should go in the story instead of a vote which can expire or be missed.',
