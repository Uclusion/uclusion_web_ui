...
const messages = defineMessages({
  ...
  inviteLinkerTicketCode: 'Human friendly task identifier',
  ...
  maxMaxBudgetInputLabel: 'maximum task budget',
  daysEstimateInputLabel: 'Very rough number of days to complete',
  votesRequiredInputLabelShort: 'Approvals Required',
  votesRequiredInputHelperText: 'Number of approvals required to start on a task',
  ...
  storyTitlePlaceholder: 'Name your task',
  optionTitlePlaceholder: 'Name your option',
  agilePlanFormTitlePlaceholder: 'Name your channel',
  ...
  agilePlanFormMaxMaxBudgetInputLabel: 'Optionally enter a budget number for this task.',
  ...
  editMarketButtonPlan: 'Channel settings',
  ...
  investibleEditAcceptLabel: 'Accept Task',
  investibleEditArchiveLabel: 'Archive Task',
  ...
  planningInvestibleNotDoingExplanation: 'Move to Not Doing will unassign and archive the task',
  planningInvestibleVerifiedExplanation: 'Move to Verified when you no longer anticipate further work on the task',
  planningInvestibleFurtherWorkExplanation: 'Move to this stage when a handoff to another assignee is expected for this task',
  ...
  votesRequiredHelp: "Number of approvals desired before starting a task",
  ticketSubCodeHelp: 'A short code for the channel which will be used to form human readable task ids',
  ticketSubCodeHelp1: 'Your task ids will look like U-{code}-0, U-{code}-1, U-{code}-2, etc.',
  maxBudgetHelp: 'Maximum budget allowed for a task. Used to prevent stories from being too large.',
  ...
  issueWarningPlanning: 'Opening an issue moves this task to blocked and stops new approval.',
  todoWarningPlanning: 'Opening a TODO prevents moving to Verified stage until resolved.',
  requiresInputWarningPlanning: 'Opening this comment will move the task to Requires Input.',
  ...
  cardTypeAgilePlan: 'channel - description',
  ...
  homeAddDecision: 'Dialog',
  homeAddPlanning: 'Channel',
  homeAddPlanningExplanation: 'Create a channel when you want to discuss a project or assign tasks',
  ...
  homeAddInitiative: 'Initiative',
  homePlanningReport: 'Active Task Value Estimates (in days)',
  homeViewArchives: 'View Archive',
  homeAddNew: 'Add New',
  homeViewAbout: 'About',
  homeCreatedAt: 'Created on {dateString}',
  archiveWarning: 'Muting will unassign any active task. Deactivating stops the channel for everyone.',
  new: 'New',
  ...
  planningDialogManageParticipantsExplanation: 'Add collaborators to this channel',
  ...
  planningNoneInVerifiedWarning: 'No Verified task',
  ...
  noName: 'Must create a name or text description for this task.',
  nameRequired: 'Name is a required field.',
  noQuantity: 'Must provide your certainty for this task.',
  ...
  noQuestionUploads: 'Questions should go in their own comment and pictures should go in the task.',
  noUploads: 'Pictures should go in the task instead of a vote which can expire or be missed.',
  collaborators: 'Collaborators',
  inlineAddLabel: 'Add Option',
  inlineAddLabelMobile: 'Option',
  addStoryLabel: 'Add Task',
  ...
  inlineAddExplanation: 'Add options for how to do this task and collect approval.',
  deactivateInlineQuestion: 'Changing stage will deactivate any dialogs associated with this task.',
  deactivateDialogQuestion: 'Do you want to deactivate and stop any further work?',
  activateDialogQuestion: 'This channel is inactive. Do you want to activate and continue work?',
  ...
  investibleDescription: 'Task - Add',
  ...
  createFurtherWorkExplanation: 'Create a new task that sends a notification demanding assignment.',
  ...
  // your voting
  yourVotingVoteForThisPlanning: 'Approve this task',
  ...
  errorPlanningInvestibleAddFailed: 'There was a problem adding the task',
  errorInvestibleStageChangeFailed: 'There was a problem accepting or archiving the task',
  ...
  errorMarketActivateFailed: 'There was a problem activating the channel',
  ...
  todoPresent: 'TODO',
  issueTip: 'Use to halt an option or task until resolved.',
  questionTip: 'Question',
  suggestTip: 'Suggestion',
  reportTip: 'Used to report status.',
  reportReviewTip: 'Report made after review of this task. Required reviewers must create.',
  todoTip: 'Use to insure this item is done in this task.',
  ...
  OnboardingWizardCurrentStoryStepLabel: 'Current Task',
  OnboardingWizardCurrentStoryProgressStepLabel: 'Current Task Progress (Optional)',
  OnboardingWizardNextStoryStepLabel: 'Next Task (Optional)',
  OnboardingWizardAdvancedOptionsStepLabel: 'Task short code',
  OnboardingWizardCurrentStoryNamePlaceHolder: 'Your current task\'s name',
  OnboardingWizardCurrentStoryDescriptionPlaceHolder: 'Your current task\'s description',
  OnboardingWizardNextStoryNamePlaceHolder: 'Your next task\'s name',
  OnboardingWizardNextStoryDescriptionPlaceHolder: 'Your next task\'s description',
  OnboardingWizardCurrentStoryProgressPlaceHolder: 'Your progress so far',

  //RequirementsWorkspaceWizard
  ReqWorkspaceWizardTitle: 'Your channel',
  ReqWorkspaceWizardNamePlaceHolder: 'Your channel name',
  ReqWorkspaceWizardNameStepLabel: 'Your channel',
  ...
  ReqWorkspaceWizardCreatingworkspaceStepLabel: 'Creating channel',
  ReqWorkspaceNameStepIntro: 'Great! We\'re creating a structured environment for group editing and discussion.',
  ReqWorkspaceNameStepHelp: 'Your channel\'s name could be the name of a project, the name of your team or anything else you want to sync on.',
  ...
  ApprovalRestrictNo: 'Allow assignees to approve their own task.',
