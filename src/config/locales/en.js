...
const messages = defineMessages({
  ...
  planningInvestibleToVotingLabel: 'Voting',
  ...
  planningInvestibleEnoughVotesHelp: 'This story has enough votes so consider using \'Change stage\' to move \'In Progress\'',
