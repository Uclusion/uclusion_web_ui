...
const messages = defineMessages({
  ...
  planningAcceptedStageDescription: 'Stories in \'Not Ready For Feedback\' per person per workspace is a setting. A yellow story in \'Not Ready For Feedback\' has a no progress report notification.',
  ...
  stageHelp1: 'Ideas and requirements go in the workspace description or Further Work and bugs in workspace TODOs.',
  stageHelp2: 'Move or create a story in "Ready for Approval" to get approval.',
  stageHelp3: 'Only an assignee can move the story to "Not Ready For Feedback" ',
  ...
  createWorkspaceGreeting: 'Welcome {name}',
  createdWorkspaceContent: 'Uclusion can create a Workspace for continuous improvement for you.',
  createWorkspaceStart: 'Create the Workspace',
  new: 'New',
