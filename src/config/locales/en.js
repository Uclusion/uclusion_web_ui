...
const messages = defineMessages({
  ...
  addReportInReadyForApprovalWarning: 'If this job is started then consider moving to \'Not Ready for Feedback\' stage.',
  ...
  planningDialogNavStoriesLabel: 'Jobs',
  ...
  allowedInvestiblesDropdownHelp: 'Number of jobs to allow in \'Not Ready For Feedback\' per person',
  allowedInvestiblesDropdownLabel: 'Maximum jobs not ready for feedback',
