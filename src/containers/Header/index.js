...
import Groups from '../../components/CustomChip/Groups'
import SearchBox from '../../components/Search/SearchBox'
import { MarketsContext } from '../../contexts/MarketsContext/MarketsContext'
import { getFirstGroup, getFirstWorkspace } from '../../utils/redirectUtils'
...
function Header (props) {
  ...
  const { toolbarButtons, appEnabled, hideTools, navMenu, isInbox } = props;
      ...
      >
        <Toolbar className={classes.topBar}>
          <div className={classes.sidebar}>
            ...
            <div className={classes.notification} id="notifications">
              <div id='workspacesJar' key='inbox' onClick={(event) => {
                preventDefaultAndProp(event);
                const marketId = getFirstWorkspace(marketState);
                const groupId = getFirstGroup(groupState, marketId);
                navigate(history, formMarketLink(marketId, groupId));
              }} className={classes.bellButton}>
                <Badge className={classes.chip} overlap="circular">
                  <Fab id='notifications-fabInbox' className={classes.fab} disabled={!isInbox}>
