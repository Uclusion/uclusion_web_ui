...
import { getInvestiblesFetching, getInvestibles, productPropType } from './reducer'
...
const mapStateToProps = (state, props) => ({
  loading: getInvestiblesFetching(state.products),
  investibles: getInvestibles(state.investibles)
})

function mapDispatchToProps(dispatch) {
  return Object.assign({ dispatch }, bindActionCreators({ fetchInvestibles, closeSearch }, dispatch));
}
