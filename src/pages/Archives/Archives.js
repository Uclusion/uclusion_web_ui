...
import {
  getArchivedMarketDetailsForType,
...
function Archives(props) {
  ...
  const planningDetails = getArchivedMarketDetailsForType(marketsState, PLANNING_TYPE);
  const decisionDetails = getArchivedMarketDetailsForType(marketsState, DECISION_TYPE);
  const initiativeDetails = getArchivedMarketDetailsForType(marketsState, INITIATIVE_TYPE);
