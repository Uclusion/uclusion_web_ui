  ...
  if (tabIndex === PENDING_INDEX) {
    return (
      <Typography style={{marginTop: '2rem', maxWidth: '40rem', marginLeft: 'auto', marginRight: 'auto'}}
                  variant="body1">
        Your From You tab is empty.<br/><br/> Process or poke anything waiting on others here.
      </Typography>
    );
  }
...
export function getOutboxMessages(props) {
  const { marketsState, marketPresencesState,groupPresencesState, investiblesState, marketStagesState, commentsState,
    intl } = props;
